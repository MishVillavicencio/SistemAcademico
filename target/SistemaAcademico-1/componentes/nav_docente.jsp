        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-edit"></i> Gestión de Calificaciones <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="form_advanced.html">Registrar / Actualizar Nota</a></li>
                            <li><a href="form_validation.html">Resultados exámenes</a></li>
                            <li><a href="form_wizards.html">Promedio</a></li>
                            <li><a href="form_upload.html">Top 3 mejores</a></li>
                            <li><a href="form_buttons.html">Generar informe final</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
